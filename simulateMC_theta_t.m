function S_tau_all = simulateMC_theta_t(eps_t_all_1, eps_t_all_2, xt_prime_1, xt_prime_2, xt_prime_3, xt_prime_4, f_xt_prime_1, f_xt_prime_2, f_xt_prime_3, f_xt_prime_4, ut_prime_1, ut_prime_2,...
    t, h, T, a, b, s, danger_y1, danger_y2, eta, k1, k2, k3)
    ...
    for t_prime = t:h:T % this loop is to compute S(tau_i)
        ...
        S_tau = S_tau - h*b*(xt_prime_1*xt_prime_1 + xt_prime_2*xt_prime_2) - h*(a/2)*((ut_prime_1*ut_prime_1 + ut_prime_2*ut_prime_2)); %add the state dependent running cost
        
        xt_prime_1 = xt_prime_1 + f_xt_prime_1*h; %move tau ahead
        xt_prime_2 = xt_prime_2 + f_xt_prime_2*h; %move tau ahead
        xt_prime_3 = xt_prime_3 + f_xt_prime_3*h + ut_prime_1*h + s*eps_t_prime_1*sqrt(h); %move tau ahead
        xt_prime_4 = xt_prime_4 + f_xt_prime_4*h + ut_prime_2*h + s*eps_t_prime_2*sqrt(h); %move tau ahead
